    ...
    <section id="PROSPECTUS" className="py-32 px-8 md:px-12 bg-void border-b border-structure/20 text-signal relative">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl bg-void/50 border border-structure/30 rounded-xl overflow-hidden shadow-2xl p-4 flex flex-col gap-6">
          <div className="relative w-full h-[650px] bg-black/40 rounded-lg overflow-hidden border border-structure/20">
            <object
              data="/prospectus.pdf"
        ...
        <div className="mt-20 flex flex-col items-center gap-6">
          <div className="text-[10px] font-code text-gray-600 tracking-[0.2em] uppercase">Ready to join our journey?</div>
          <a
            href={ctaLink}
            target="_blank"
            rel="noopener noreferrer"
            className="px-10 py-4 rounded-full border border-structure/50 text-[11px] tracking-[0.2em] font-code text-gray-400 hover:border-signal hover:text-signal hover:bg-white/5 transition-all duration-300 shadow-xl bg-void/30 backdrop-blur-md"
          >
            {ctaText}
          </a>
        </div>
